...
import message.types.AskForConnectedUserNamesMsg;
import message.types.ReceiveChatClosureMsg;
import message.types.ReceiveChatRequestAnswerMsg;
import message.types.ReceiveChatRequestMsg;
import message.types.ReceiveConnectedUserNamesMsg;
import message.types.ReceiveConnectionMsg;
import message.types.ReceiveDisconnectionMsg;
import message.types.ReceiveMessageMsg;
import message.types.SendConnectedUserNamesMsg;
